    ...
    >
      <div class="flex">
        <div v-if="!noIcon" class="icon">
          <span v-if="icon" class="text-current">
            <i :class="icon"></i>
          </span>
          <span v-else class="default">
            <svg v-if="type === 'default'" class="h-5 w-5" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true">
            ...
            <svg v-if="type === 'warning'" class="h-5 w-5" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true">
              <path fill-rule="evenodd" d="M8.257 3.099c.765-1.36 2.722-1.36 3.486 0l5.58 9.92c.75 1.334-.213 2.98-1.742 2.98H4.42c-1.53 0-2.493-1.646-1.743-2.98l5.58-9.92zM11 13a1 1 0 11-2 0 1 1 0 012 0zm-1-8a1 1 0 00-1 1v3a1 1 0 002 0V6a1 1 0 00-1-1z" clip-rule="evenodd" />
            </svg>
            <svg v-if="type === 'danger'" class="h-5 w-5" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true">
              <path fill-rule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zM8.707 7.293a1 1 0 00-1.414 1.414L8.586 10l-1.293 1.293a1 1 0 101.414 1.414L10 11.414l1.293 1.293a1 1 0 001.414-1.414L11.414 10l1.293-1.293a1 1 0 00-1.414-1.414L10 8.586 8.707 7.293z" clip-rule="evenodd" />
            </svg>
            <svg v-if="type === 'info'" class="h-5 w-5" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor">
          ...
          <div v-if="href || slots.href" class="callback">
            <div class="-mx-2 -my-1.5 flex">
              <a v-if="href" :href="href" :title="hrefText" :target="hrefTarget">
                ...
                <svg v-else class="h-4 w-5" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor">
                  <path fill-rule="evenodd" d="M12.293 5.293a1 1 0 011.414 0l4 4a1 1 0 010 1.414l-4 4a1 1 0 01-1.414-1.414L14.586 11H3a1 1 0 110-2h11.586l-2.293-2.293a1 1 0 010-1.414z" clip-rule="evenodd" />
                </svg>
              </a>
              <slot v-if="slots.href" name="href"></slot>
              <button v-if="dismiss" @click="dismissAble">{{ dismissText }}</button>
            </div>
          </div>
        </div>
        <div v-if="dismiss && (!slots.href && !href)" class="dismiss">
          <div class="-mx-1.5 -my-1.5">
            <button @click="dismissAble">
...
.i-alert .callback button {
  @apply ml-2;
}
.i-alert .callback button, .i-alert .callback a,
.i-alert .dismiss button {
...
.i-alert-success .callback button,
.i-alert-success .callback a,
.i-alert-success .dismiss button {
...
.i-alert-warning .callback button,
.i-alert-warning .callback a,
.i-alert-warning .dismiss button {
...
.i-alert-danger .callback button,
.i-alert-danger .callback a,
.i-alert-danger .dismiss button {
...
.i-alert-info .callback button,
.i-alert-info .callback a,
.i-alert-info .dismiss button {
